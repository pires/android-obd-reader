package com.github.pires.obd.reader.acra;
...
import static com.github.pires.obd.reader.activity.ConfigActivity.getAcraEmail;
...
public class ACRAPostSender implements ReportSender {
    ...
    public void send(Context context, CrashReportData report) throws ReportSenderException {
        ...
        String url = getUrl(PreferenceManager.getDefaultSharedPreferences(context));
        if (url != null) {
